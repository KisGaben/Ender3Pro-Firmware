...
#define HOMING_BUMP_DIVISOR { 2, 2, 2 }  // Re-Bump Speed Divisor (Divides the Homing Feedrate) Customized DBP according to the original Ender 3 firmware
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Lift Z axis" //Customized DBP
  #define USER_GCODE_1 "G91\nG0 Z50\nM84" //Customized DBP

  #define USER_DESC_2 "Filament change" //Customized DBP
  #define USER_GCODE_2 "G28\nM109 R" STRINGIFY(PREHEAT_1_TEMP_HOTEND) "\nG92 E0\nG1 E10 F100\nM0 Change filament\nG92 E0\nG1 E100 F100\nG28\nM104 S0\nM117 Done!\nM84" //Customized DBP

  #define USER_DESC_3 "Emergency Stop" //Customized DBP
  #define USER_GCODE_3 "M112" //Customized DBP
#endif
