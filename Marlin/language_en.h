...
#undef en
  ...
  #define MSG_USER_MENU                       _UxGT("Tools")
#endif
  ...
  #define MSG_BLTOUCH_SW_MODE                 _UxGT("SW-Mode")
#endif
#ifndef MSG_BLTOUCH_5V_MODE
  #define MSG_BLTOUCH_5V_MODE                 _UxGT("5V-Mode")
#endif
#ifndef MSG_BLTOUCH_OD_MODE
  #define MSG_BLTOUCH_OD_MODE                 _UxGT("OD-Mode")
#endif
